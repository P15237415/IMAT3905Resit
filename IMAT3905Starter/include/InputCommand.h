...
class MoveLeftXYCommand : public InputCommand
{
	void execute(GameObject& player);
};
class MoveRightXYCommand : public InputCommand
{
	void execute(GameObject& player);
};
class MoveUpXYCommand : public InputCommand
{
	void execute(GameObject& player);
};
class MoveDownXYCommand : public InputCommand
{
	void execute(GameObject& player);
};
