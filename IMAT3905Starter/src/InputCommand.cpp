...
{
	player.OnMessage("Level3");
}

void MoveLeftXYCommand::execute(GameObject& player)
{
	player.OnMessage("leftXY");
}
void MoveRightXYCommand::execute(GameObject& player)
{
	player.OnMessage("rightXY");
}
void MoveUpXYCommand::execute(GameObject& player)
{
	player.OnMessage("upXY");
}
void MoveDownXYCommand::execute(GameObject& player)
{
	player.OnMessage("downXY");
}
